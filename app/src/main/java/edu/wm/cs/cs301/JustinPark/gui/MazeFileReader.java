...
import edu.wm.cs.cs301.JustinPark.generation.BSPBranch;
import edu.wm.cs.cs301.JustinPark.generation.BSPLeaf;
        ...
        try{
            ...
            for (int temp = 0 ; temp < nList.getLength() ; temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    seed = getElementIntValue("seed", eElement);
                    manual = getElementIntValue("driver", eElement);
                    System.out.println("MANUAL IN READER");
